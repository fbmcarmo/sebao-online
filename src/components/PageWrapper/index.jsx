...
export default function PageWrapper({children, showHeader = true, showFooter = true, showLogo = false}){
    return (
        <div className="w-full h-full min-h-screen flex flex-col">
             {showLogo && (<div className="w-[10%] h-full flex items-center justify-center gap-1 pl-2">
